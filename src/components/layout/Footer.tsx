      ...
      <div className="container py-6 md:py-14 relative z-10">
        ...
        <div className="md:hidden space-y-5">
          ...
          <div className="flex flex-col items-center text-center space-y-3">
            ...
            <div className="flex gap-2">
              <a href="https://www.linkedin.com/company/dynamic-global-services/" target="_blank" rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-primary-foreground/10 flex items-center justify-center hover:bg-accent hover:text-accent-foreground transition-all">
          ...
          <nav className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-xs">
            {navLinks.map((link) => (
              <Link key={link.name} to={link.href} className="text-primary-foreground/80 hover:text-accent transition-colors">
                {link.name}
              </Link>
            ))}
          </nav>
          ...
          {/* Contact essentials */}
          <div className="flex flex-col items-center gap-2 text-xs border-t border-primary-foreground/10 pt-4">
            <a href="mailto:contact@dgsafrica.com" className="flex items-center gap-2 text-primary-foreground/80 hover:text-accent transition-colors">
              <Mail className="w-3.5 h-3.5" /> contact@dgsafrica.com
            </a>
            <a href="https://api.whatsapp.com/send?phone=221776862024" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-primary-foreground/80 hover:text-accent transition-colors">
              <WhatsAppIcon className="w-3.5 h-3.5" /> +221 77 686 20 24
            </a>
            <span className="flex items-center gap-2 text-primary-foreground/60">
              <MapPin className="w-3.5 h-3.5" /> {t('common.senegal')}
            </span>
          </div>

          {/* Bottom */}
          <div className="border-t border-primary-foreground/10 pt-3 flex flex-col items-center gap-2">
            <p className="text-primary-foreground/50 text-[11px] text-center">
