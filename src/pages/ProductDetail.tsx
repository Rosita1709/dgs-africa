...
const productsData: ProductData[] = [
  ...
  },
  {
    ...
    galleryImages: [
      "/products/inverter-hybrid.jpg",
      "/products/inverter-ongrid.jpg",
      "/products/inverter-offgrid.jpg",
      "/products/battery-lithium.jpg",
    ],
    color: "green",
    servicePath: "/services/energie",
    ...
    productsFr: [
      { name: "Onduleurs Hybrides", description: "Onduleurs intelligents combinant solaire, réseau et batteries pour une flexibilité maximale et une autonomie totale en cas de coupure.", image: "/products/inverter-hybrid.jpg" },
      { name: "Onduleurs On-Grid", description: "Connexion directe au réseau électrique avec injection du surplus de production. Réduction immédiate de la facture énergétique.", image: "/products/inverter-ongrid.jpg" },
      { name: "Onduleurs Off-Grid", description: "Solutions autonomes pour sites isolés sans raccordement au réseau. Idéal pour les zones rurales et les installations distantes.", image: "/products/inverter-offgrid.jpg" },
      { name: "Batteries Lithium", description: "Stockage d'énergie haute capacité pour une autonomie prolongée jour et nuit. Technologie LiFePO4 pour une durée de vie optimale.", image: "/products/battery-lithium.jpg" },
    ],
    productsEn: [
      { name: "Hybrid Inverters", description: "Smart inverters combining solar, grid, and batteries for maximum flexibility and total autonomy during outages.", image: "/products/inverter-hybrid.jpg" },
      { name: "On-Grid Inverters", description: "Direct grid connection with surplus production injection. Immediate energy bill reduction.", image: "/products/inverter-ongrid.jpg" },
      { name: "Off-Grid Inverters", description: "Autonomous solutions for isolated sites without grid connection. Ideal for rural areas and remote installations.", image: "/products/inverter-offgrid.jpg" },
      { name: "Lithium Batteries", description: "High-capacity energy storage for extended day and night autonomy. LiFePO4 technology for optimal lifespan.", image: "/products/battery-lithium.jpg" },
    ],
  },
  {
    slug: "monitoring",
    ...
    galleryImages: [
      "/products/smart-meter.jpg",
      "/products/iot-sensors.jpg",
      "/products/monitoring-dashboard.jpg",
      "/products/monitoring-alerts.jpg",
    ],
    color: "green",
    servicePath: "/services/energie",
    ...
    productsFr: [
      { name: "Compteurs Intelligents", description: "Mesure précise de la consommation et de la production avec transmission de données en temps réel. Compatible avec toutes les installations DGS.", image: "/products/smart-meter.jpg" },
      { name: "Capteurs IoT", description: "Capteurs connectés pour température, humidité, irradiance solaire et qualité de l'air. Installation plug-and-play.", image: "/products/iot-sensors.jpg" },
      { name: "Plateformes de Supervision", description: "Interfaces web et mobile pour visualiser et analyser les performances de vos installations en temps réel, depuis n'importe où.", image: "/products/monitoring-dashboard.jpg" },
      { name: "Solutions d'Alerte", description: "Systèmes de notification automatique (SMS, email, app) en cas d'anomalie, de sous-performance ou de maintenance nécessaire.", image: "/products/monitoring-alerts.jpg" },
    ],
    productsEn: [
      { name: "Smart Meters", description: "Precise consumption and production measurement with real-time data transmission. Compatible with all DGS installations.", image: "/products/smart-meter.jpg" },
      { name: "IoT Sensors", description: "Connected sensors for temperature, humidity, solar irradiance, and air quality. Plug-and-play installation.", image: "/products/iot-sensors.jpg" },
      { name: "Supervision Platforms", description: "Web and mobile interfaces to visualize and analyze your installations' performance in real time, from anywhere.", image: "/products/monitoring-dashboard.jpg" },
      { name: "Alert Solutions", description: "Automatic notification systems (SMS, email, app) for anomalies, underperformance, or maintenance needs.", image: "/products/monitoring-alerts.jpg" },
    ],
  },
];
