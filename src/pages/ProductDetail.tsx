...
const productsData: ProductData[] = [
  ...
  {
    slug: "equipements-it",
    titleFr: "Matériel Informatique — Dell, Blackview, HP, Lenovo",
    titleEn: "IT Equipment — Dell, Blackview, HP, Lenovo",
    image: "/products/laptop-generic.jpg",
    galleryImages: [
      "/products/laptop-generic.jpg",
      "/products/dell-server.jpg",
      "/products/printer.jpg",
    ],
    color: "accent",
    servicePath: "/services/it",
    partnerName: "Dell / Blackview / HP / Lenovo",
    descriptionFr: "DGS est partenaire Dell Technologies, distributeur Blackview et fournisseur HP en Afrique de l'Ouest. Nous équipons les entreprises, institutions et administrations en solutions informatiques complètes : ordinateurs, tablettes, serveurs, imprimantes, stockage et accessoires audio.",
    descriptionEn: "DGS is a Dell Technologies partner, Blackview distributor, and HP supplier in West Africa. We equip businesses, institutions, and administrations with complete IT solutions: computers, tablets, servers, printers, storage, and audio accessories.",
    whyDgsFr: "Un interlocuteur unique pour l'ensemble de votre parc informatique : garantie constructeur, configuration sur mesure et support technique de proximité.",
    whyDgsEn: "A single point of contact for your entire IT fleet: manufacturer warranty, custom configuration, and local technical support.",
    detailsFr: [
      "Partenaire officiel Dell Technologies & distributeur Blackview",
      "Fournisseur HP pour l'Afrique de l'Ouest",
      "Ordinateurs professionnels Dell Latitude, Lenovo ThinkPad, OptiPlex",
      "Tablettes durcies Blackview IP68/IP69K pour usage terrain",
      "Serveurs Dell PowerEdge Rack & Tower",
      "Imprimantes HP laser, jet d'encre et multifonctions",
      "Accessoires : stockage USB, écouteurs, casques audio pro",
      "Configuration, déploiement et maintenance assurés par DGS",
    ],
    detailsEn: [
      "Official Dell Technologies partner & Blackview distributor",
      "HP supplier for West Africa",
      "Professional computers: Dell Latitude, Lenovo ThinkPad, OptiPlex",
      "Blackview rugged tablets IP68/IP69K for field use",
      "Dell PowerEdge Rack & Tower servers",
      "HP laser, inkjet, and multifunction printers",
      "Accessories: USB storage, earphones, professional headsets",
      "Configuration, deployment, and maintenance by DGS",
    ],
    productsFr: [
      { name: "Ordinateurs Portables", description: "Dell Latitude, Lenovo ThinkPad et Blackview Rugged. Gammes professionnelles certifiées, sécurisées et managées pour l'usage intensif en entreprise.", image: "/products/laptop-generic.jpg" },
      { name: "Ordinateurs de Bureau", description: "Dell OptiPlex et Lenovo ThinkCentre. Postes de travail compacts et puissants avec sécurité renforcée et gestion centralisée pour les flottes d'entreprise." },
      { name: "Tablettes Blackview", description: "MEGA 12 (première tablette 5G IP69K au monde), Active 7, ZENO Series. Tablettes durcies et performantes pour le terrain et le bureau mobile." },
      { name: "Serveurs Dell PowerEdge", description: "Serveurs rack et tour pour data centers et PME. Solutions de virtualisation, stockage NAS/SAN et haute disponibilité.", image: "/products/dell-server.jpg" },
      { name: "Imprimantes HP", description: "Imprimantes laser, jet d'encre, multifonctions et grand format A3. Fourniture régulière de consommables (toners, cartouches).", image: "/products/printer.jpg" },
      ...
      { name: "Clés USB & Stockage", description: "Clés USB 3.0 et USB-C de 16 Go à 256 Go, disques durs externes portables et cartes mémoire SD/microSD haute vitesse." },
      { name: "Écouteurs & Audio Pro", description: "Écouteurs filaires, casques Bluetooth avec réduction de bruit, casques audio pro pour centres d'appels et kits mains libres." },
    ],
    productsEn: [
      { name: "Laptops", description: "Dell Latitude, Lenovo ThinkPad, and Blackview Rugged. Certified, secure, and managed professional ranges for intensive business use.", image: "/products/laptop-generic.jpg" },
      { name: "Desktop Computers", description: "Dell OptiPlex and Lenovo ThinkCentre. Compact and powerful workstations with enhanced security and centralized management for enterprise fleets." },
      { name: "Blackview Tablets", description: "MEGA 12 (world's first IP69K 5G tablet), Active 7, ZENO Series. Rugged and high-performance tablets for field and mobile office use." },
      { name: "Dell PowerEdge Servers", description: "Rack and tower servers for data centers and SMBs. Virtualization, NAS/SAN storage, and high-availability solutions.", image: "/products/dell-server.jpg" },
      { name: "HP Printers", description: "Laser, inkjet, multifunction, and A3 large format printers. Regular consumables supply (toners, cartridges).", image: "/products/printer.jpg" },
      ...
      { name: "USB Drives & Storage", description: "USB 3.0 and USB-C drives from 16 GB to 256 GB, portable external hard drives, and high-speed SD/microSD memory cards." },
      { name: "Headphones & Pro Audio", description: "Wired earphones, Bluetooth headsets with noise cancellation, pro audio headsets for call centers, and hands-free kits." },
    ],
  },
  {
